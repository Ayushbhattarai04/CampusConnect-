    ...
    >
      ...
      <div className="w-1/2 bg-white/95 backdrop-blur-sm flex flex-col rounded-3xl m-4 shadow-2xl overflow-y-auto">
        ...
        <div className="flex-1 px-12 pb-8">
          ...
          {/* Success Message */}
          {successMessage && (
            <div className="mb-6 p-4 bg-green-50 border-2 border-green-400 rounded-xl flex items-start gap-3">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-5">
              ...
              <div className="relative">
                <IdCard className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-500" />
                <input
                  type="text"
