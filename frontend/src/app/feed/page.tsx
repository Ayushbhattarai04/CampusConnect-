        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-20">
            ...
            <div className="lg:col-span-2 space-y-4  overflow-y-auto">
              <div className="fixed-  ">
                <h6 className=" mt-2 pb-3 text-4xl tracking-tighter font-bold">
                  Campus Connect Feed
                </h6>
                <h6 className="pb-4 font-mono text-lg tracking-tighter">
                  ...
                  <div className="flex items-center gap-4 pt-4  mt-4">
                    ...
                    >
                      <Heart
                        size={20}
                        fill={
                          hasUserLiked(post.postId) ? "currentColor" : "none"
                        }
                      />
            ...
            {/* RIGHT COLUMN  */}
            <div className="lg:col-span-1 space-y-4 sticky top-0  pt-4  pr-2">
              {/* COMMUNITIES CARD */}
              <div className="backdrop-blur-lg bg-gray-100/30 border border-gray-300 rounded-4xl shadow-sm p-6  top-0">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2>
                    <Link
                      href="/communities"
                      className="w-full ml-20 py-2 text-blue-600 font-semibold hover:bg-blue-50 rounded-lg transition-colors hover:transition-colors"
                    >
                      View All
                    </Link>
                  </h2>
                </div>
                <div className="space-y-2 flex flex-row gap-2 overflow-x-auto ">
                  <div className="p-4 bg-white border-gray-200 rounded-2xl text-center text-sm hover:bg-gray-300 cursor-pointer transition-colors">
                    <p className="font-semibold  text-gray-900">
                      {communities[0]?.name || "Loading..."}
                    </p>
                    <p className="text-sm font-mono text-gray-500">
                      {communities[0]?.membersCount || 0} members
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 ">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="w-full text-lg font-bold   text-gray-900">
                    Job Opportunities
                  </h2>
                  <button className="w-full ml-20 py-2 tracking-tighter text-green-600 font-semibold hover:bg-green-50 rounded-lg transition-colors">
                    View All Jobs
                  </button>
                </div>
